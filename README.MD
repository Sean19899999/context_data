...
﻿Manuscript: MEPS-2023-12-035- Role of marine bivalves in the oceanic carbon cycle: physiological processes, carbon budgets and ecosystem perspectives
 ...
 4.        There are many line-level issues that take away from the thrusts I suspect the authors wish to make. In some cases, these issues not only muddle messages, but potentially lead to contradictory arguments. Those line-level comments are detailed below:
